namespace System.Web.Mvc
{
	...
	// oooooooooooh microsoft, why are all these handy classes internal?
		...
		internal class ServerExecuteHttpHandlerWrapper : Page
		{
			...
			protected static TResult Wrap<TResult>(Func<TResult> func)
			{
				...
				catch (HttpException he)
				{
					...
					{
						HttpException newHe = new HttpException(500, "Execution of the child request failed. Please examine the InnerException for more information.", he);
						throw newHe;
					}
				}
			}
